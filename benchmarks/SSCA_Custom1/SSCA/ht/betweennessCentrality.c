...
extern  LONG_T  *volatile tmp_start;
extern  LONG_T  *volatile tmp_end;
extern  VERT_T  *volatile tmp_S;
extern  DOUBLE_T  *volatile tmp_sig;
extern  LONG_T    *volatile tmp_d;
extern  DOUBLE_T  *volatile tmp_del;
extern  plist  *volatile tmp_P;
extern  graph  *volatile tmp_G;
extern int volatile push_flag;
extern int volatile g_hot2_j;
extern int volatile g_phase_num;
extern int volatile g_vertex;
extern  DOUBLE_T *volatile tmp_BC;
