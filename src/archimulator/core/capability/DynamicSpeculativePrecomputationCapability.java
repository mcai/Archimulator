 ...
 ******************************************************************************/
package archimulator.core.capability;
...
import archimulator.mem.ext.delinquentLoad.AbstractDelinquentLoadIdentificationTable;
import archimulator.mem.ext.delinquentLoad.DelinquentLoad;
...
public class DynamicSpeculativePrecomputationCapability implements ProcessorCapability {
    ...
    private Map<archimulator.core.Thread, AbstractDelinquentLoadIdentificationTable> dlits;
    private Map<archimulator.core.Thread, RetiredInstructionBuffer> ribs;
