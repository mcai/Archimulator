...
public class CoherentCacheBeginCacheAccessEvent extends CoherentCacheEvent {
    ...
    public CoherentCacheBeginCacheAccessEvent(GeneralCacheController cacheController, MemoryHierarchyAccess access, CacheAccess<?> cacheAccess) {
    ...
    public String toString() {
        return String.format("CoherentCacheBeginCacheAccessEvent{access=%s, cache.name=%s}", access, getCacheController().getCache().getName());
    }
}
