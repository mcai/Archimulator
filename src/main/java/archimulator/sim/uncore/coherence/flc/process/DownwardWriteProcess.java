...
public class DownwardWriteProcess extends CoherentCacheProcess {
    private boolean completed;
    private boolean error;

    public DownwardWriteProcess(FirstLevelCache cache, final MemoryHierarchyAccess access, final int tag) {
        super(cache);
