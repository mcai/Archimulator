...
public class DownwardReadProcess extends CoherentCacheProcess {
    private boolean shared;
    private boolean completed;
    private boolean error;

    public DownwardReadProcess(FirstLevelCache cache, final MemoryHierarchyAccess access, final int tag) {
        super(cache);
