...
public class PutSLastEvent extends DirectoryControllerEvent {
    ...
    public PutSLastEvent(DirectoryController generator, CacheCoherenceFlow producerFlow, CacheController req, int tag) {
        super(generator, producerFlow, DirectoryControllerEventType.PUTS_LAST);
        this.req = req;
        this.tag = tag;
    }
