...
/**
 * The event fired when an L1 cache controller receives a "forwarded GetS" message.
 *
 * @author Min Cai
 */
public class FwdGetSEvent extends CacheControllerEvent {
    ...
    /**
     * Create an event when an L1 cache controller receives a "forwarded GetS" message.
     *
