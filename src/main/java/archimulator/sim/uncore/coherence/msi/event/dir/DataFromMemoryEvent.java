...
public class DataFromMemoryEvent extends DirectoryControllerEvent {
    ...
    public DataFromMemoryEvent(DirectoryController generator, CacheCoherenceFlow producerFlow, CacheController req, int tag) {
        super(generator, producerFlow, DirectoryControllerEventType.DATA_FROM_MEMORY);
        this.req = req;
        this.tag = tag;
    }
