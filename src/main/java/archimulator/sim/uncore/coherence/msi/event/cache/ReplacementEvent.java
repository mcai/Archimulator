...
public class ReplacementEvent extends CacheControllerEvent {
    ...
    public ReplacementEvent(CacheController generator, CacheCoherenceFlow producerFlow, int tag, int set, int way, Action onCompletedCallback, Action onStalledCallback) {
        super(generator, producerFlow, CacheControllerEventType.REPLACEMENT);
        this.tag = tag;
        this.set = set;
        this.way = way;
