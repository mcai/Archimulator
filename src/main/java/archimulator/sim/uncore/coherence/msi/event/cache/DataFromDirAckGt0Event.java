...
public class DataFromDirAckGt0Event extends CacheControllerEvent {
    ...
    public DataFromDirAckGt0Event(CacheController generator, CacheCoherenceFlow producerFlow, Controller sender, int tag) {
        super(generator, producerFlow, CacheControllerEventType.DATA_FROM_DIR_ACK_GT_0);
        this.sender = sender;
        this.tag = tag;
    }
