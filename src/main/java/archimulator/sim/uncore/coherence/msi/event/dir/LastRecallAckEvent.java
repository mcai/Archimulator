...
public class LastRecallAckEvent extends DirectoryControllerEvent {
    ...
    public LastRecallAckEvent(DirectoryController generator, CacheCoherenceFlow producerFlow, int tag) {
        super(generator, producerFlow, DirectoryControllerEventType.LAST_RECALL_ACK);
        this.tag = tag;
    }
