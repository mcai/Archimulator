...
//        evictionPolicyClasses.add(LFUPolicy.class);
    ...
    public static <StateT extends Serializable> EvictionPolicy<StateT> createEvictionPolicy(Class<? extends EvictionPolicy> evictionPolicyClz, EvictableCache<StateT> cache) {
        try {
