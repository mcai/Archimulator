...
import archimulator.core.speculativePrecomputation.DynamicSpeculativePrecomputationHelper;
...
import archimulator.uncore.cache.replacement.reuseDistancePrediction.ReuseDistancePredictionHelper;
...
import archimulator.uncore.delinquentLoad.DelinquentLoadIdentificationHelper;
...
public abstract class Simulation implements SimulationObject, Reportable {
    ...
    public Kernel prepareKernel() {
        ...
        for (final ContextMapping contextMapping : this.getExperiment().getConfig().getContextMappings()) {
