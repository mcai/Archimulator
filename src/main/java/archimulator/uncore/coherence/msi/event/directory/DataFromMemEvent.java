...
/**
 * The event fired when the directory controller receives a "data" message from the memory controller.
 *
 * @author Min Cai
 */
public class DataFromMemEvent extends DirectoryControllerEvent {
    ...
    /**
     * Create an event when the directory controller receives a "data" message from the memory controller.
     *
