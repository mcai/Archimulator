...
public class LoadEvent extends CacheControllerEvent {
     ...
     */
    public LoadEvent(CacheController generator, CacheCoherenceFlow producerFlow, int tag, int set, int way, Runnable onCompletedCallback, Runnable onStalledCallback, MemoryHierarchyAccess access) {
