...
public class GetSEvent extends DirectoryControllerEvent {
     ...
     */
    public GetSEvent(DirectoryController generator, CacheCoherenceFlow producerFlow, CacheController requester, int tag, int set, int way, Runnable onStalledCallback, MemoryHierarchyAccess access) {
