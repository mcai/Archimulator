...
import archimulator.uncore.net.noc.routers.InputVirtualChannel;
...
public class ACONode extends Node {
    ...
    private void createAndSendBackwardAntPacket(ForwardAntPacket packet) {
        BackwardAntPacket newPacket = new BackwardAntPacket(
                ...
                packet.getDest(),
                packet.getSrc(),
                this.getNetwork().getSettings().getExperiment().getConfig().getAntPacketSize(),
                null);
    ...
    public Direction select(int src, int dest, int ivc, List<Direction> directions) {
        ...
        for(Direction direction : directions) {
            ...
            double alpha = this.getNetwork().getSettings().getExperiment().getConfig().getAcoSelectionAlpha();
            double qTotal = this.getNetwork().getSettings().getExperiment().getConfig().getMaxInputBufferSize();
