...
/**
 * A net message begin link transfer event.
 *
 * @author Min Cai
 */
public class NetMessageBeginLinkTransferEvent extends SimulationEvent {
    private Net net;
    private NetNode nodeFrom;
    private NetNode nodeTo;

    /**
     * Create a net message begin link transfer event.
     *
     * @param net the parent net
     * @param nodeFrom the source node
     * @param nodeTo the destination node
     */
    public NetMessageBeginLinkTransferEvent(Net net, NetNode nodeFrom, NetNode nodeTo) {
        super(net);
