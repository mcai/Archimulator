...
ssh root@$REMOTE_SERVER_IP 'cd /home/itecgo/Archimulator; nohup `java -cp "out/artifacts/Archimulator_jar/Archimulator.jar:out/artifacts/Archimulator_jar/jna.jar" archimulator.sim.Startup` &'
#ssh root@$REMOTE_SERVER_IP 'cd /home/itecgo/Archimulator; java -cp "out/artifacts/Archimulator_jar/Archimulator.jar:out/artifacts/Archimulator_jar/jna.jar" archimulator.sim.Startup'